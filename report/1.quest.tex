...
No entanto, sabendo que o intervalo da pool do DHCP não contem o IP
atribuído a Term1, podemos concluir que este IP lhe está reservado.

Se tivéssemos observado uma mensagem do tipo DHCP Inform saberíamos que o
atual cliente tem um IP estático definido por si e apenas pretende
obter informação extra (Servidor DNS e Default Gateway, por
exemplo).
